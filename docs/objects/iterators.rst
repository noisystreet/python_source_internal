...
看看 CPython 如何实现 :ref:`int <objects-long>` 、:ref:`str <objects-unicode>` 、:ref:`dict <objects-dict>` 、:ref:`list <objects-list>` 这些每天使用的类型。

参考资料
--------

- :ref:`objects-func-code` — 函数调用中的生成器帧
- :ref:`concurrency-async` — async/await 与协程的关系
- :file:`Objects/iterobject.c` — 序列迭代器实现
- :file:`Objects/genobject.c` — 生成器实现
- :pep:`342` — 增强型生成器
